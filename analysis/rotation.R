...
df <- read.csv("C:/Users/cur_z/OneDrive/Desktop/Dalhousie University/research/User Study/PerspectAR-User-Study-Data/Analysis_Data_MyGaze_Enabled/euler_angles_statistics_by_task_per_participant_condition.csv")
...
for (var in dependent_vars) {
  ...
  model <- lmer(as.formula(paste(model_var, "~ Condition * Task * Dataset + (1 | PairID)")), data = df)
